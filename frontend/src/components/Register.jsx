        ...
        <div className="column">
            <form className="box" onSubmit={handleSubmit}>
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input type="password" placeholder="Enter password" value={confirmationPassword} onChange={(e) => setConfirmationPassword(e.target.value)}
                        classname="input" required />
                    </div>
                </div>
                <ErrorMessage message={errorMessage} />
                <br />
                <button className="button is-primary" type="sumbit">
                    Register
                </button>
